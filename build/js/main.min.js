...
exports.showSuccessMessage = void 0;
...
require("./modules/show-more/show-more");
require("./modules/adaptive-runner/index");
require("./modules/custom-select/index");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  window.addEventListener('load', function () {
    ...
    window.form = form;
    form.init();
    (0, _slider.initHeroSwiper)();
    (0, _initTabs.initTabs)();
    (0, _slider.initPartnersSwiper)();
    (0, _slider.initProjectsSwiper)();
...
var onSuccessAnywhereClick = function onSuccessAnywhereClick(evt) {
...
var onSuccessButtonClick = function onSuccessButtonClick() {
  if (successTemplate) {
    successTemplate.remove();
  }
};
var showSuccessMessage = exports.showSuccessMessage = function showSuccessMessage() {
...
},{"./modules/accordion/init-accordion":3,"./modules/adaptive-runner/index":5,"./modules/custom-select/index":6,"./modules/form-validate/form":11,"./modules/menu/menu":17,"./modules/modals/init-modals":18,"./modules/show-more/show-more":20,"./modules/slider/slider":21,"./modules/tabs/init-tabs":22}],2:[function(require,module,exports){
"use strict";
...
function _toPropertyKey(arg) { var key = _toPrimitive(arg, "string"); return _typeof(key) === "symbol" ? key : String(key); }
function _toPrimitive(input, hint) { if (_typeof(input) !== "object" || input === null) return input; var prim = input[Symbol.toPrimitive]; if (prim !== undefined) { var res = prim.call(input, hint || "default"); if (_typeof(res) !== "object") return res; throw new TypeError("@@toPrimitive must return a primitive value."); } return (hint === "string" ? String : Number)(input); }
var AdaptiveRunner = exports.AdaptiveRunner = /*#__PURE__*/function () {
  ...
  _createClass(AdaptiveRunner, [{
    ...
    value: function templateRunner() {
      return "<div class=\"about__tabs tabs adaptive-runner\" ".concat(window.innerWidth >= 768 ? '' : 'data-adaptive-runner="runner"', ">\n      <div class=\"adaptive-runner__inner\"></div>\n      <button class=\"about__tab\" type=\"button\" data-tabs=\"control\" data-index=\"0\" data-adaptive-runner=\"checkpoint\">\n      <img class=\"about__icon\" src=\"./img/sprite/about-tab1.svg\" alt=\"\">\n    </button>\n    <button class=\"about__tab\" type=\"button\" data-tabs=\"control\" data-index=\"1\" data-adaptive-runner=\"checkpoint\">\n      <img class=\"about__icon\" src=\"./img/sprite/about-tab2.svg\" alt=\"\">\n    </button>\n    <button class=\"about__tab\" type=\"button\" data-tabs=\"control\" data-index=\"2\" data-adaptive-runner=\"checkpoint\">\n      <img class=\"about__icon\" src=\"./img/sprite/about-tab3.svg\" alt=\"\">\n    </button>\n    <button class=\"about__tab\" type=\"button\" data-tabs=\"control\" data-index=\"3\" data-adaptive-runner=\"checkpoint\">\n      <img class=\"about__icon\" src=\"./img/sprite/about-tab4.svg\" alt=\"\">\n    </button>\n    <button class=\"about__tab\" type=\"button\" data-tabs=\"control\" data-index=\"4\" data-adaptive-runner=\"checkpoint\">\n      <img class=\"about__icon\" src=\"./img/sprite/about-tab5.svg\" alt=\"\">\n    </button>\n    <button class=\"about__tab\" type=\"button\" data-tabs=\"control\" data-index=\"5\" data-adaptive-runner=\"checkpoint\">\n      <img class=\"about__icon\" src=\"./img/sprite/about-tab6.svg\" alt=\"\">\n    </button>\n    </div>");
    }
  }, {
    key: "renderRunner",
    ...
    value: function run(track, checkpoint, runner) {
      ...
      var left = "-".concat(checkpoint.offsetLeft / 2, "px");
...
var _adaptiveRunner = require("./adaptive-runner");
window.addEventListener('DOMContentLoaded', function () {
  window.addEventListener('load', function () {
    var adaptiveRunner = new _adaptiveRunner.AdaptiveRunner();
    adaptiveRunner.init();
  });
});

},{"./adaptive-runner":4}],6:[function(require,module,exports){
"use strict";
...
},{"./select/custom-select":8}],7:[function(require,module,exports){
"use strict";
...
},{"./create-select-markup":7,"./utils":9}],9:[function(require,module,exports){
"use strict";
  ...
  _createClass(Form, [{
    ...
    value: function _initValidate(parent) {
      ...
      form.addEventListener('submit', function (event) {
        ...
        if (_this4.validateForm(event.target)) {
          // проверяем, прошла ли форма валидацию
          // console.log('Форма отправлена успешно');
          (0, _main.showSuccessMessage)();
        }
      });
...
},{"../../main":1,"./callback":10,"./init-phone-input":12,"./validator":16}],12:[function(require,module,exports){
"use strict";
...
var social = document.querySelector('.main-header__social');
...
},{"../../utils/focus-lock":24,"../../utils/scroll-lock":26}],20:[function(require,module,exports){
"use strict";

// Для описания карточек жизненного цикла
var buttonShowMore = document.querySelectorAll('.life-cycle__link');
var moreLinkClickHandler = function moreLinkClickHandler(evt) {
  var element = evt.target.closest('a.life-cycle__link');
  if (!element) {
    return;
  }
  evt.preventDefault();
  var cardContainer = element.closest('.life-cycle__item');
  var descriptionElement = cardContainer.querySelector('.life-cycle__description');
...
var showMore = document.querySelector('.life-cycle__more');
showMore.addEventListener('click', function () {
  var arr = Array.from(document.querySelector('.life-cycle__list').children);
...
var reviewsShowMore = document.querySelectorAll('.reviews__button');
var reviewsMoreLinkClickHandler = function reviewsMoreLinkClickHandler(evt) {
  var element = evt.target.closest('button.reviews__button');
  if (!element) {
    return;
  }
  evt.preventDefault();
  var cardContainer = element.closest('.reviews__card');
  var descriptionElement = cardContainer.querySelector('.reviews__description');
  if (descriptionElement) {
...
exports.initPartnersSwiper = initPartnersSwiper;
exports.initProjectsSwiper = initProjectsSwiper;
...
},{"./tabs":23}],23:[function(require,module,exports){
"use strict";
